...
vim.api.nvim_create_autocmd({'BufLeave', 'CursorMoved','CmdwinLeave', 'WinLeave', 'CmdlineLeave', 'ExitPre'}, {
...
-- vim.api.nvim_create_autocmd({ 'TextChanged', 'BufLeave', 'VimLeavePre', 'WinLeave' }, {
--     pattern = { '*', 'yml', 'yaml', 'metainfo' },
--     group = austrip,
